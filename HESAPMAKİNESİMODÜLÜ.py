Math Modullerini Kullanarak Gelişmiş Hesap makinesi Modulu
...
Bölme İşlemi = 4
Üs Alma İşlemi = 5
Karekök Alma İşlemi = 6
Logaritma Bulma İşlemi = 7
Dereceden Radyana Çevirme İşlemi = 8
Radyandan Dereceye Çevirme İşlemi = 9
Girilen Açının Sin Değerini Bulma İşlemi = 10
Girilen Açının Cos Değerini Bulma İşlemi = 11
Girilen Açının Tan Değerini Bulma İşlemi = 12
Girilen Açının Cot Değerini Bulma İşlemi = 13
